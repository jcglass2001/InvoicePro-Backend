...
public class ExceptionUtils {
    public static void processError(HttpServletRequest request, HttpServletResponse response, Exception exception){
        if(exception instanceof ApiException || exception instanceof DisabledException || exception instanceof BadCredentialsException ||
        ...
        log.error("processError(): {}",exception.getMessage());
    }
    ...
    private static void writeResponse(HttpServletResponse response, HttpResponse httpResponse) {
        ...
        try{
            ...
            log.error("writeResponse(): {}",exception.getMessage());
        }
    }
